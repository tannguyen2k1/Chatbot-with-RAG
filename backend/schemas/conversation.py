...
class ConversationUpdate(BaseModel):
    title: str | None = Field(None, description="Tiêu đề cuộc hội thoại mới")
...
class CreateConversationWithMessageRequest(BaseModel):
    ...
    title: str | None = Field(None, description="Tiêu đề (tự động tạo nếu không cung cấp)")
    ...
    score_threshold: float | None = Field(default=None, description="Ngưỡng loại bỏ rác")
    ...
    system_prompt: str | None = Field(None, description="System prompt tùy chỉnh")
